...
export default function MaterialPlannerProductCategoryTreeView(props) {
    return (
        <>
        ...
        return (
            <>
                <details className="tree-nav__item is-expandable">
                    <summary className="tree-nav__item_demo tree-nav__item-title" id={"material-planner-summary-id-"+props.node.id}>
                        <a onClick={(event) => {
