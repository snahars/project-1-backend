...
export function RejectToRejectView(props) {
    const intl = useIntl();
                            ...
                            <div>
                                ...
                                <div className='mt-2'>
                                    <Card className='booking-view-card'>
                                        <CardBody>
                                            <span className='booking-activities-title'>Payment Verification <span style={{ color: "#EB5757" }}>{paymentVerification == "REJECTED" ? "Rejected" : ""}</span></span>
                    ...
                    <div className="timeline-item align-items-start">
                        ...
                        <div>
                            ...
                            <div className='mt-2'>
                                <Card className='booking-view-card'>
                                    <CardBody>
                                        <span className='booking-activities-title'>{intl.formatMessage({id: "REJECTTOREJECTVIEW.PAYMENT_COLLECTION"})}</span>
                                        <p className='booking-activities-details'>
                                            {paymentInfo.remarks}
                                        </p>
                                    </CardBody>
