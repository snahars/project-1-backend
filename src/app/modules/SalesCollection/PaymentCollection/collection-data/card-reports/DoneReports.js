...
export function DoneReports(props) {
    const intl = useIntl();
    ...
    return (
        <>
            <div>
                {
                    props.oRDCommissionAdjustment == "Completed" ?
                        <Card className="reports-card-delivery">
                            <CardBody>
                                <div>
                                    <p className='report-sales-booking-title'>
                                    {intl.formatMessage({id: "DONEREPORTS.ORD_COMMISSION_ADJUSTMENT"})}
                                    </p>
                                </div>
                    ...
                    props.paymentAdjustment == "Completed" ?
                        <Card className="reports-card-delivery">
                            <CardBody>
                                <div>
                                    <p className='report-sales-booking-title'>
                                    {intl.formatMessage({id: "PAYMENT.PAYMENT_ADJUSTMENT"})}
                                    </p>
                                </div>
                    ...
                    props.paymentVerification == "APPROVED" ?
                        ...
                        <Card className="reports-card-delivery">
                            <CardBody>
                                <div>
                                    <p className='report-sales-booking-title'>
                                    {intl.formatMessage({id: "DONEREPORTS.COLLECTION_VERIFICATION"})}
                                    </p>
                                </div>
                ...
                <Card className="booking-reports-card">
                    <CardBody>
                        <div>
                            <p className='report-sales-booking-title'>
                            {intl.formatMessage({id: "PAYMENT.PAYMENT_COLLECTION"})}
                            </p>
                        </div>
