...
export default function ProfitabilityAnalysisReport() {
    ...
    const generateProfitabilityAnalysisReport = () => {
        ...
        queryString += 'companyId=' + companyId;
        queryString += '&locationId=' + inputs.locationId;
        queryString += '&salesOfficerId=' + inputs.salesOfficerId;
        ...
        const URL = `${process.env.REACT_APP_API_URL}/api/reports/profitability-analysis` + queryString;
        axios.get(URL, { responseType: 'blob' }).then(response => {
            ...
            if (inputs.reportType === "PDF") {
                link.setAttribute('download', "Profitability_Analysis.pdf");
                ...
                link.setAttribute('download', "Profitability_Analysis.xlsx");
            }
    ...
    const preview = () => {
        ...
        queryString += '&endDate=' + inputs.endDate;
        queryString += '&distributorId=' + inputs.distributorId;
        queryString += '&reportType=' + "PDF";

        const dataURL = `${process.env.REACT_APP_API_URL}/api/reports/profitability-analysis` + queryString;
    ...
    return (
        <>
            <div>
                <MisReportBreadCrum menuTitle="Profitability Analysis Report" />
            </div>
            <div>
                <Card>
                    <CardBody>
                        <div className='row'>
                            ...
                            <div className='col-xl-7'>
                                ...
                                <Button className="float-right mt-5" id="gotItBtn" variant="contained"
                                    color="primary"
                                    onClick={generateProfitabilityAnalysisReport}
                                >
                                    Generate
                                </Button>
